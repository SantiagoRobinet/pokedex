...
import { loadPokemonById } from '../../redux/actions/pokemonActions';
...
function mapStateToProps({ pokemonReducer }) {
  return {
    pokemonDetail: pokemonReducer.pokemonDetail,
    loading: pokemonReducer.loading,
    error: pokemonReducer.error,
  };
}
